...
function adjustCircleSize(selected, circle, circlePositions)
  ...
  elseif selected == 'red' then
    animation.zoom(background, circle['green'], circlePositions['green'].x, circlePositions['green'].y, scale, 0)
    animation.zoom(background, circle['yellow'], circlePositions['yellow'].x, circlePositions['yellow'].y, scale^2, 0)
    animation.zoom(background, circle['blue'], circlePositions['blue'].x, circlePositions['blue'].y, scale^4, 0)
  elseif selected == 'green' then
    animation.zoom(background, circle['red'], circlePositions['red'].x, circlePositions['red'].y, scale, 0)
    animation.zoom(background, circle['yellow'], circlePositions['yellow'].x, circlePositions['yellow'].y, scale, 0)
    animation.zoom(background, circle['blue'], circlePositions['blue'].x, circlePositions['blue'].y, scale^2, 0)
  elseif selected == 'yellow' then
